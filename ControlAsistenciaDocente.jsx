...
export default function ControlDeAsistencia() {
  ...
  const puedeEditar = ["administrador", "directivo", "docente", "profesor"].includes(usuario);
  ...
  return (
    <div className="docente-module-page asistencia-docente-page" style={styles.container}>
      ...
      <div className="asistencia-toolbar" style={styles.toolbar}>
        <input
          type="text"
        ...
        />
        <button
          className="asistencia-save-button"
          ...
          <tbody>
            {estudiantesFiltrados.map((est) => (
              <tr key={est.id} style={styles.tr}>
                ...
                <td style={styles.td}>
                  <div className="asistencia-actions" style={styles.actions}>
                    <button
